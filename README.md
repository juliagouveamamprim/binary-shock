...
We export a frozen PSR B1259−63 scene to GLB, loadig it in
a browser Three.js viewer. The goal is a cinematic scientific diorama
with geometry and scalar mappings that remain traceable to analytic model.
...
field ranges, units, and artistic visual choices. 
...
model, but the visible points are a display sampling, and not simulation generated
